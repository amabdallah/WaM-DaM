...
<a href="https://github.com/amabdallah/WaM-DaM/blob/master/02UseCases/TestUseCases.rar" target="_blank"> TestUseCases.rar </a> folder and follow the instructions on how to use SQLite Manager in Mozilla Firefox to execute the SQL queries against the provided populated WaM-DaM database. 
