...
def BUILD_MSSSQL_DDL(opts, ddl_objs, use_schemas):
    ...
    outdir = os.path.join(os.path.abspath(opts.output), 'WaM-DaM_for_MSSQL.sql')
...
def BUILD_POSTGRES_DDL(opts, ddl_objs, use_schemas):
    ...
    outdir = os.path.join(os.path.abspath(opts.output), 'WaM-DaM_for_PostgreSQL.sql')
    with open(outdir, 'w') as f:
...
def BUILD_MYSQL_DDL(opts, ddl_objs, use_schemas):
    ...
    outdir = os.path.join(os.path.abspath(opts.output), 'WaM-DaM_for_MySQL.sql')
    with open(outdir, 'w') as f:
...
def BUILD_SQLITE_DDL(opts, ddl_objs, use_schemas):
    ...
    outdir = os.path.join(os.path.abspath(opts.output), 'WaM-DaM_for_SQLite.sql')
    with open(outdir, 'w') as f:
...
def main(argv):
    ...
    print '|     WaM-DaM DDL Building Tool      |'
    print '|---------------------------------|'
