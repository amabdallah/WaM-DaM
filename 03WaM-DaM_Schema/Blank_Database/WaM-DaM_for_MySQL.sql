...
ALTER TABLE Mapping ADD CONSTRAINT fk_Mapping_AttributeTypeCode
FOREIGN KEY (AttributeTypeCodeCV) REFERENCES AttributeTypeCode (Term)
ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE Mapping ADD CONSTRAINT fk_Mapping_DataStorage
...
ALTER TABLE Mapping ADD CONSTRAINT fk_Mapping_ObjectAttributes
...
ALTER TABLE MultiColumnArray ADD CONSTRAINT fk_MultiColumnArray_DataStorage1
FOREIGN KEY (DataStorageID) REFERENCES DataStorage (DataStorageID)
ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE MultiColumnArray ADD CONSTRAINT fk_MultiColumnArray_DataStorage2
...
ALTER TABLE Rules ADD CONSTRAINT fk_Rules_DataStorage1
FOREIGN KEY (DataStorageID) REFERENCES DataStorage (DataStorageID)
ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE Rules ADD CONSTRAINT fk_Rules_DataStorage2
FOREIGN KEY (RuleVariableID) REFERENCES DataStorage (DataStorageID)
ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE Rules ADD CONSTRAINT fk_Rules_Symbols
