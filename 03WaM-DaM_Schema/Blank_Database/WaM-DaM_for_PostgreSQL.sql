...
-- Generated by Adel Abdallah August19,2015 based on WaM-DaM XML design named WaMDaMAugust19_2015
...
create table WaMDaM.Rules (
	...
	rulevariableid integer  NULL,
	rulevariableorder integer  NOT NULL,
	symbolcv varchar (255) NULL,
...
alter table WaMDaM.Mapping add constraint fk_Mapping_AttributeTypeCode
foreign key (AttributeTypeCodeCV) References WaMDaM.AttributeTypeCode (Term)
on update no Action on delete cascade;

alter table WaMDaM.Mapping add constraint fk_Mapping_DataStorage
...
alter table WaMDaM.Mapping add constraint fk_Mapping_ObjectAttributes
...
alter table WaMDaM.MultiColumnArray add constraint fk_MultiColumnArray_DataStorage1
foreign key (DataStorageID) References WaMDaM.DataStorage (DataStorageID)
on update no Action on delete cascade;

alter table WaMDaM.MultiColumnArray add constraint fk_MultiColumnArray_DataStorage2
foreign key (ColumnNameID) References WaMDaM.DataStorage (DataStorageID)
on update no Action on delete cascade;
...
alter table WaMDaM.Rules add constraint fk_Rules_DataStorage1
foreign key (DataStorageID) References WaMDaM.DataStorage (DataStorageID)
on update no Action on delete cascade;

alter table WaMDaM.Rules add constraint fk_Rules_DataStorage2
foreign key (RuleVariableID) References WaMDaM.DataStorage (DataStorageID)
on update no Action on delete cascade;

alter table WaMDaM.Rules add constraint fk_Rules_Symbols
