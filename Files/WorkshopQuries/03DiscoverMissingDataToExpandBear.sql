...
SELECT DISTINCT"ObjectTypes"."NativeObjectName", Count(DISTINCT NativeAttributeName) AS '# of needed Attributes'
...
("NativeObjectName" IN (SELECT  DISTINCT  "NativeObjectName" 
...
-- to simplify this query, remove Objects that dont require attributes of input data. These objects serve for output data. 
-- also remove the objects which dont have Common Object Type (controlled vocabulary) 
AND CommonObjectType!='Null' AND NativeAttributeName!='ObjectInstances'

-- Exclude the Objects that already available in other sources like in the other use case
-- %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
("CommonObjectType" NOT IN (SELECT  DISTINCT "CommonObjectType"
